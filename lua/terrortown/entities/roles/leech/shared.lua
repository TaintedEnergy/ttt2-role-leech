...
CreateConVar("ttt2_leech_refill_radius", 50000.0, flags)
CreateConVar("ttt2_leech_refill_multiplier", 5.0, flags)
CreateConVar("ttt2_leech_starve_time", 30.0, flags)
CreateConVar("ttt2_leech_tick_length", 0.02, flags)
...
if CLIENT then
	function ROLE:AddToSettingsMenu(parent)
		...
		form:MakeHelp({
			label = "desc_ttt2_leech_refill_radius"
		})
		form:MakeSlider({
			serverConvar = "ttt2_leech_refill_radius",
			label = "label_ttt2_leech_refill_radius",
			min = 0,
			max = 1000000,
			decimal = 0,
		})
		...
		form:MakeHelp({
			label = "desc_ttt2_leech_refill_multiplier"
		})
		form:MakeSlider({
			serverConvar = "ttt2_leech_refill_multiplier",
			label = "label_ttt2_leech_refill_multiplier",
			min = 0,
			max = 100,
			decimal = 2,
		})
		...
		form:MakeHelp({
			label = "desc_ttt2_leech_starve_time"
		})
		form:MakeSlider({
			serverConvar = "ttt2_leech_starve_time",
			label = "label_ttt2_leech_starve_time",
			min = 0,
			max = 100,
			decimal = 2,
		})
		...
		form:MakeHelp({
			label = "desc_ttt2_leech_tick_length"
		})
		form:MakeSlider({
			serverConvar = "ttt2_leech_tick_length",
			label = "label_ttt2_leech_tick_length",
			min = 0,
			max = 1,
			decimal = 2,
		})
